...
if(Meteor.isServer){
  import { AllergyIntolerances, Bundles, CarePlans, CareTeams, CodeSystems, Conditions, Compositions, Claims, DiagnosticReports, DocumentManifest, DocumentReference, Encounters, Endpoints, ExplanationOfBenefits, Immunizations, Lists, Measures, MeasureReports, Medications, MedicationOrders, MedicationStatements, Observations, Organizations, Patients, Procedures, Provenances, RiskAssessments, SearchParameters, ServiceRequests, StructureDefinitions, Tasks,  ValueSets } from 'meteor/clinical:hl7-fhir-data-infrastructure';
